...
import { LogOut, User as UserIcon, Home, BookOpen, Settings, Users, BarChartHorizontalBig, BookMarked } from 'lucide-react';
                ...
                <div className="flex h-full max-h-screen flex-col gap-2">
                    ...
                    <div className="flex-1">
                        <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                            ...
                            {/* --- THIS IS THE PRECISE PLACEMENT --- */}
                            {user.role === 'admin' && <NavLink to="/dashboard/manage-users"><Users className="h-4 w-4" />Manage Users</NavLink>}
                            {user.role === 'admin' && <NavLink to="/dashboard/manage-courses"><BookMarked className="h-4 w-4" />Manage Courses</NavLink>}
                            {user.role === 'student' && <NavLink to="/dashboard/my-report"><BarChartHorizontalBig className="h-4 w-4" />My Report</NavLink>}
                            {/* --- END PRECISE PLACEMENT --- */}
