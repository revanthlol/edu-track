...
// HSL color values pulled directly from Tailwind's theme for perfect sync
const colors = {
                        ...
                        <ResponsiveContainer width="100%" height={350}>
                            <BarChart data={stats.enrollmentByCourse}>
                                ...
                                <Tooltip
                                    ...
                                    contentStyle={{ background: 'hsl(var(--background))', borderRadius: '0.5rem', border: '1px solid hsl(var(--border))' }}
                                />
